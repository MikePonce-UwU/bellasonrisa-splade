            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    @role('Padre de familia')
                        ...
                        <span class="px-6 py-12">
                            [{{ str(auth()->user()->latestInvoice->created_at->shortMonthName)->ucfirst() }}] <b>Última factura
                                registrada: </b>{{ str(auth()->user()->latestInvoice->numero_factura)->upper }}</span>
