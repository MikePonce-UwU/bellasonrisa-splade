...
<x-app-layout>
    ...
    <x-splade-modal name="nuevoEstudianteModal">
        ...
        <x-splade-form :action="route('students.store')">
            ...
            <x-splade-select label="Seleccione el padre de familia:" name="tutor_id"
                :options="$tutors" placeholder="Selecciona el padre..." class="my-2" />
            <x-splade-select label="Seleccione el grado al que el Estudiante pertenece:" name="grade_id"
                :options="$grades" placeholder="Selecciona el grado..." class="my-2" />
