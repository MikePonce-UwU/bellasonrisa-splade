            ...
            <div class="bg-white shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <x-splade-form :default="$invoice" method="put" :action="route('invoices.update', $invoice)"
                        @role(['Maestro', 'Sub-director']) disabled @endrole>
                        ...
                        <x-splade-group name="tipo_factura" label="Tipo de factura:" inline>
                            <x-splade-radio name="tipo_factura" label="Arancel" value="arancel" />
                            <x-splade-radio name="tipo_factura" label="Arancel" value="compra_uniforme_escolar" />
                            <x-splade-radio name="tipo_factura" label="Arancel" value="compra_uniforme_deportivo" />
                            <x-splade-radio name="tipo_factura" label="Arancel" value="matricula" />
                            <x-splade-radio name="tipo_factura" label="Arancel" value="pago_planilla" />
