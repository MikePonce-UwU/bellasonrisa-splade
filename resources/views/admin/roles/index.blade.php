...
<x-app-layout>
    ...
    <x-splade-modal name="nuevoRoleModal">
        ...
        <x-splade-form :action="route('roles.store')" method="post">
            ...
            <x-splade-select label="Seleccione el permiso:" name="permissions" :options="$permissions" multiple choices relation
                placeholder="Seleccione un permiso..." class="mb-2" />
