            ...
            <div class="bg-white shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <x-splade-form :default="$user_detail" method="put" :action="route('user_details.update', $user_detail)" class="grid grid-cols-12 gap-6">
                        ...
                        <x-splade-select label="Usuario:" name="user_id" :options="$users" disabled
                            placeholder="Seleccione un usuario..." class="mb-2 col-span-12" />
                        <x-splade-input label="Salario:" name="salario" placeholder="Salario del empleado"
                            class="col-span-6" />
                        <x-splade-input label="Adelanto de salario:" name="adelantos"
                            placeholder="Adelantos del empleado" class="col-span-6" />
                        ...
                        <x-splade-select label="Días que el maestro trabaja:" name="dias_laborales" :options="[
                            ...
                            multiple choices placeholder="Seleccione los días..." class="mb-2 col-span-12" />
                        <x-splade-select label="Materias que el maestro enseña:" name="materias" :options="$subjects"
                            multiple choices placeholder="Seleccione las materias..."
